...
- [Job Trucking](https://github.com/ipassynk/job-trucker-ai) Job trucking tool using RAG with Ollama, LangChain, ChromaDB, FastAPI, and Streamlit. Airflow for RAG automation.
