...
- Multi-agent LangChain agent that learns your communication style, retrieves info from documents, evaluates responses for style and grounding, and books meetings if confidence is low.
